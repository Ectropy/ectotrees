...
src/
  ...
  constants/toolColors.ts # Re-export shim for shared-browser/toolColors.ts (canonical UI color tokens moved there so alt1-plugin can import them via @shared-browser)
  constants/__tests__/
