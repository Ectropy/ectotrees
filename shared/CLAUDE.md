...
shared/
  ...
  protocol.ts           # ClientMessage and ServerMessage discriminated unions; also exports MemberRole, MemberInfo, SessionSummary, and MAX_MEMBER_NAME_LEN (client-side input cap for member names)
